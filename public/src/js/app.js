if ('serviceWorker' in navigator) { // check is browser has sw
    navigator.serviceWorker.register('/sw.js') ////registration process takes some time.....register return a promise
        .then(function() {
